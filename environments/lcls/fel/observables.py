...
class observables(): #does this need to be a class?

    name = 'fel_observables'
    variables = {}
    observables = []

    def get_intensity_n_loss(self, hxr, points, loss_pv, fel_channel, interface):
    ...
    def get_loss(self, points, loss_pv, interface):  # if only loss is observed
            logging.info(f'Get value of {points} points')
